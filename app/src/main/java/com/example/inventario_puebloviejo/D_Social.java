...
public class D_Social extends AppCompatActivity implements CallBack {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dsocial);

        db = new DataBase(this);
        recyclerView = findViewById(R.id.VistaDesarrolloSocial);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        queryEquipo();
/*
        date = new ArrayList<>();
        date = db.mostrarDrlloSocial();

        AdapterEquipo adapter = new AdapterEquipo(date, this);
        recyclerView.setAdapter(adapter);
*/
        Button generarPDFbtn = findViewById(R.id.btnPDFDesarrolloS);
    ...
    private void generarPDF() {
        ...
        intent.putExtra(Intent.EXTRA_TITLE, "Equipos D. Social.pdf");
    ...
    private void queryEquipo(){
        String url = "https://inventariopv.estudiasistemas.com/inventory/api.php?tk=220220240740&area=Desarrollo Social";
