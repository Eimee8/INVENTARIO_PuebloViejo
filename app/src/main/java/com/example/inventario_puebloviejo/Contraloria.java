...
public class Contraloria extends AppCompatActivity implements CallBack {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_contraloria);

        db = new DataBase(this);
        recyclerView = findViewById(R.id.VistaContraloria);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        queryEquipo();
/*
        date = new ArrayList<>();
        date = db.mostrarContraloria();

        AdapterEquipo adapter = new AdapterEquipo(date, this);
        recyclerView.setAdapter(adapter);
*/
        Button generarPDFbtn = findViewById(R.id.btnPDFContraloria);
    ...
    private void generarPDF() {
        ...
        intent.putExtra(Intent.EXTRA_TITLE, "Equipos Contraloria.pdf");
    ...
    private void queryEquipo(){
        String url = "https://inventariopv.estudiasistemas.com/inventory/api.php?tk=220220240740&area=Contraloria";
