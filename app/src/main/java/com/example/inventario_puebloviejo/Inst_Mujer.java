...
public class Inst_Mujer extends AppCompatActivity implements CallBack {
...
*/
        Button generarPDFbtn = findViewById(R.id.btnPDFInsMujer);
    ...
    private void generarPDF() {
        ...
        intent.putExtra(Intent.EXTRA_TITLE, "Equipos Ins. Mujer.pdf");
    ...
    private void queryEquipo(){
        String url = "https://inventariopv.estudiasistemas.com/inventory/api.php?tk=220220240740&area=Instituto De La Mujer";
