...
public class Comercio extends AppCompatActivity implements CallBack {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.VistaComercio);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        queryEquipo();
/*
        date = new ArrayList<>();
        date = db.mostrarComercio();

        AdapterEquipo adapter = new AdapterEquipo(date, this);
        recyclerView.setAdapter(adapter);
*/
        Button generarPDFbtn = findViewById(R.id.btnPDFComercio);
    ...
    private void generarPDF() {
        ...
        intent.putExtra(Intent.EXTRA_TITLE, "Equipos Comercio.pdf");
    ...
    private void queryEquipo(){
        String url = "https://inventariopv.estudiasistemas.com/inventory/api.php?tk=220220240740&area=Comercio";
