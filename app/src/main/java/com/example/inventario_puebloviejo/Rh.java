...
public class Rh extends AppCompatActivity implements CallBack {
...
*/
    ...
    private void queryEquipo(){
        String url = "https://inventariopv.estudiasistemas.com/inventory/api.php?tk=220220240740&area=Recursos Humanos";
