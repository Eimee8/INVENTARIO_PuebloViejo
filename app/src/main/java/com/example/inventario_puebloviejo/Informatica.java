...
public class Informatica extends AppCompatActivity implements CallBack {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.VistaInformatica);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        queryEquipo();
/*
        date = new ArrayList<>();
        date = db.mostrarInformatica();

        AdapterEquipo adapter = new AdapterEquipo(date, this);
        recyclerView.setAdapter(adapter);
*/
        Button generarPDFbtn = findViewById(R.id.btnPDFInformatica);
    ...
    private void generarPDF() {
        ...
        intent.putExtra(Intent.EXTRA_TITLE, "Equipos Informatica.pdf");
    ...
    private void queryEquipo(){
        String url = "https://inventariopv.estudiasistemas.com/inventory/api.php?tk=220220240740&area=Informatica";
