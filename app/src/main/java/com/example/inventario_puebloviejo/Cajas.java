...
public class Cajas extends AppCompatActivity implements CallBack {
...
*/
        Button generarPDFbtn = findViewById(R.id.btnPDFCajas);
    ...
    private void generarPDF() {
        ...
        intent.putExtra(Intent.EXTRA_TITLE, "Equipos Cajas.pdf");
