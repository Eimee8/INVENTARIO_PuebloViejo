...
public class Ingresos extends AppCompatActivity implements CallBack {

    private static final int REQUEST_CODE_CREATE_PDF = 123; // usar cualquier valor único aquí
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.VistaIngresos);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        queryEquipo();
        /*
        date = new ArrayList<>();
        date = db.mostrarIngresos();

        AdapterEquipo adapter = new AdapterEquipo(date, this);
        recyclerView.setAdapter(adapter);
*/
        Button generarPDFbtn = findViewById(R.id.btnPDFIngresos);
    ...
    private void generarPDF() {
        ...
        intent.putExtra(Intent.EXTRA_TITLE, "Equipos Ingresos.pdf");
