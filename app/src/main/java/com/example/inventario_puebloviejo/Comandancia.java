...
public class Comandancia extends AppCompatActivity implements CallBack {
...
*/
        Button generarPDFbtn = findViewById(R.id.btnPDFComandancia);
    ...
    private void generarPDF() {
        ...
        intent.putExtra(Intent.EXTRA_TITLE, "Equipos Comandancia.pdf");
    ...
    private void queryEquipo(){
        String url = "https://inventariopv.estudiasistemas.com/inventory/api.php?tk=220220240740&area=Comandancia";
