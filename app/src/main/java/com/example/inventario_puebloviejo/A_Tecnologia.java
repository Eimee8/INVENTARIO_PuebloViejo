...
public class A_Tecnologia extends AppCompatActivity implements CallBack {
...
*/
    ...
    private void queryEquipo(){
        String url = "https://inventariopv.estudiasistemas.com/inventory/api.php?tk=220220240740&area=Area De Tecnologia";
