...
public class Regidores extends AppCompatActivity implements CallBack {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_regidores);

        db = new DataBase(this);
        recyclerView = findViewById(R.id.VistaRegidores);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        queryEquipo();
/*
        date = new ArrayList<>();
        date = db.mostrarRegidores();

        AdapterEquipo adapter = new AdapterEquipo(date, this);
        recyclerView.setAdapter(adapter);
*/
        Button generarPDFbtn = findViewById(R.id.btnPDFRegidores);
    ...
    private void generarPDF() {
        ...
        intent.putExtra(Intent.EXTRA_TITLE, "Equipos Regidores.pdf");
    ...
    private void queryEquipo(){
        String url = "https://inventariopv.estudiasistemas.com/inventory/api.php?tk=220220240740&area=Regidores";
