...
public class Alcoholes extends AppCompatActivity implements CallBack {
...
*/
    ...
    private void generarPDF() {
        ...
        intent.putExtra(Intent.EXTRA_TITLE, "Equipos Alcoholes.pdf");
    ...
    private void queryEquipo(){
        String url = "https://inventariopv.estudiasistemas.com/inventory/api.php?tk=220220240740&area=Alcoholes";
