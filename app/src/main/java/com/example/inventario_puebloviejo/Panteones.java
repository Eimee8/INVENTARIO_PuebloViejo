...
public class Panteones extends AppCompatActivity implements CallBack {
...
*/
        Button generarPDFbtn = findViewById(R.id.btnPDFPanteones);
    ...
    private void generarPDF() {
        ...
        intent.putExtra(Intent.EXTRA_TITLE, "Equipos Panteones.pdf");
    ...
    private void queryEquipo(){
        String url = "https://inventariopv.estudiasistemas.com/inventory/api.php?tk=220220240740&area=Panteones";
