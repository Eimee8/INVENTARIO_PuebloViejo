...
public class Catastro extends AppCompatActivity implements CallBack {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.VistaCatastro);
...
*/
        Button generarPDFbtn = findViewById(R.id.btnPDFCatastro);
    ...
    private void generarPDF() {
        ...
        intent.putExtra(Intent.EXTRA_TITLE, "Equipos Catastro.pdf");
    ...
    private void queryEquipo(){
        String url = "https://inventariopv.estudiasistemas.com/inventory/api.php?tk=220220240740&area=Catastro";
